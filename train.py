...
def parse_args():
    ...
    parser.add_argument("--model_name", type=str, default="mamba_unet",
                        choices=["res_unet", "mamba_unet", "vanilla_unet", "dense_unet", "swin_unet"])
    ...
    parser.add_argument("--out_name", type=str, default="swin_unet_DIFFDDPM")
    ...
    parser.add_argument("--resume_ckpt", type=str, default=False)
...
def should_save_model(current_metrics, best_metrics):
    ...
    """
    ssim_threshold = 0.005  # Save if within 0.02 of best SSIM
    psnr_threshold = 0.01  # Save if within 0.2 of best PSNR
